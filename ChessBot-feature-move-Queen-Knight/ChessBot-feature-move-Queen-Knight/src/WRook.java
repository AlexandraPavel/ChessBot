...
public class WRook extends Piece {
    ...
    public IndexPair calculateMove(Square[][] board, int x, int y){
        ...
        if(i + 1 < 8) {
            if (i == x && board[i + 1][y].piece.colour.equals("black")) {
        ...
        if(j + 1 < 8) {
            if (j == y && board[x][j + 1].piece.colour.equals("black")) {
        ...
        if(k - 1 >= 0) {
            if (k == x && board[k - 1][y].piece.colour.equals("black")) {
        ...
        if(l - 1 >= 0) {
            if (l == y && board[x][l - 1].piece.colour.equals("black")) {

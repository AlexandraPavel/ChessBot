...
//        }
        ...
        while (true) {
            ...
            if (command.compareTo("xboard") == 0) {
                ...
                c1.fill_board();
                // c1.board[0][0] = new Square(0, 0);
                // c1.board[0][7] = new Square(0, 7);
                // c1.board[7][0] = new Square(7, 0);
                // c1.board[7][7] = new Square(7, 7);
                engine_side = "black";
                xboard_side = "white";
                move_flag = true;
                ...
                if (engine_side.compareTo("black") == 0) {
                    ...
                    ArrayList<IndexPair> available_moves = ((BKing) c1.board[black_king_position.x][black_king_position.y].piece).
                        verify_moves(c1.board, black_king_position.x, black_king_position.y, is_check_result.get(1));
                    // System.out.println(c1);
                    if ((is_check_result.get(0)).size() == 0) {
                        indices = c1.randomPiece("black", c1.board);
                        ...
                        // } else {
                        //     c1.board[indices.x][indices.y].piece.move(c1.board, indices.x, indices.y);
                        } 
                    } else if ((is_check_result.get(0)).size() == 1) {
//                        System.out.println("\nRegele trebuie sa mute sau alta piesa trebuie sa intervina");
                        // System.out.println(available_moves.get(1).x + " " + available_moves.get(1).y);
...
//                        System.out.println("\nRegele trebuie sa mute");
                    ...
                    ArrayList<IndexPair> available_moves = ((WKing) c1.board[white_king_position.x][white_king_position.y].piece).
                        verify_moves(c1.board, white_king_position.x, white_king_position.y, is_check_result.get(1));
                    // System.out.println(c1);
                    if ((is_check_result.get(0)).size() == 0) {
                        indices = c1.randomPiece("white", c1.board);
